...
const Google = ({ width = 100, height = 100, className = "" }) => {
  return (
    <svg
...
const Facebook = ({ width = 100, height = 100, className = "" }) => {
  return (
