...
export default function MobileDock() {
  ...
  const links = [
    ...
    { to: "/portal/notifications", icon: Bell,       label: "Alerts",  requireAuth: true, badge: unreadCount },
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 sm:hidden">
