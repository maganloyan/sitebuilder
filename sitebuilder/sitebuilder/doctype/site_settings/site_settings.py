...
def get_website_settings(context=None):
	...
	settings: "SiteSettings" = frappe.get_cached_doc("Site Settings")
...
def get_items(parentfield: str) -> list[dict]:
	_items = frappe.get_all(
		"Site Navbar Item",
		filters={"parent": "Site Settings", "parentfield": parentfield},
		order_by="idx asc",
		fields="*",
	)
...
def get_auto_account_deletion():
	return frappe.db.get_single_value("Site Settings", "auto_account_deletion")
